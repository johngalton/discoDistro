...
#include "../../DiscoDistroV2/togglebutton.h"
...
QT_MOC_LITERAL(3, 27, 8) // "newState"
    ...
    "toggleButton\0stateChanged\0\0newState"
};
...
void toggleButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&toggleButton::stateChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void toggleButton::stateChanged(bool _t1)
{
